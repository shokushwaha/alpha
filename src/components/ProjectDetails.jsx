        ...
        sm:space-x-4 flex-wrap"
                >
                    ...
                    <div className="flex-1 sm:py-0 py-4">
                        <div className="flex flex-col justify-start flex-wrap">
                            <h5 className="text-gray-900 text-4xl font-medium mb-2 uppercase">
                                {project?.title}
                            </h5>
                        ...
                        <div className="flex mt-2 justify-between items-center w-full pt-1">
                            <div className="flex justify-start space-x-2">
                                ...
                                <small className="text-gray-500 font-bold text-xl mx-4">
              ...
              rounded-md shadow-md hover:bg-green-700"
                        ...
                        rounded-md shadow-md hover:bg-orange-700"
                          ...
                          text-white font-medium text-xs leading-tight uppercase
                          rounded-md shadow-md hover:bg-gray-700"
                                                    onClick={() =>
                          ...
                          text-white font-medium text-xs leading-tight uppercase
                          rounded-md shadow-md hover:bg-red-700"
                                                    onClick={() =>
